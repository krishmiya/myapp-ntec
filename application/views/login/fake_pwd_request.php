            ...
            <div class="animate form login_form">
                <section class="login_confirm">
                    <div class="jumbotron">
                        ...
                        <br>
                        <h5>Please enter your email address before requesting your password</h5><br>
                        <a class="btn btn-lg btn-success" href="<?php echo base_url(); ?>Login/lost_password"><i class="fa fa-home"></i> Back </a>
                    </div>
                </section>
            </div>
