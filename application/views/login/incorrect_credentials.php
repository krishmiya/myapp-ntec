        ...
        <div class="login_wrapper">
            <div class="animate form login_form">
                <section class="login_confirm">
                    <div class="jumbotron">
                        <h3>Authentication failed</h4><br>
                        <i class="fa fa-ban fa-5x" aria-hidden="true"></i><br>
                        <h4>The user name and or password specified as tool parameters are not valid.</h4><br>													<h6>Please provide the correct user name and password</h6>                    
                    </div>
                </section>
            </div>
